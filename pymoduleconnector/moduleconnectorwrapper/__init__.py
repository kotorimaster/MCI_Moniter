...
class PyXEP(_object):
    ...
    def x4driver_set_dac_step(self, dac_step):
        """
        x4driver_set_dac_step(PyXEP self, uint8_t dac_step)
...
class PyX4M200(_object):
    ...
    def set_noisemap_control(self, noisemap_control):
        ...
        * `noisemap_control` :  
            ...
            present, and initialize and store it if not present.  
...
class PyDataRecorder(_object):
    ...
    def is_recording(self, data_type):
        """
        is_recording(PyDataRecorder self, DataType data_type) -> bool
    ...
    def process(self, data_type, data):
        """
        process(PyDataRecorder self, DataType data_type, ucVector data) -> bool
    ...
    def set_basename_for_data_type(self, data_type, name):
        """
        set_basename_for_data_type(PyDataRecorder self, DataType data_type, std::string const & name)
    ...
    def get_basename_for_data_type(self, data_type):
        """
        get_basename_for_data_type(PyDataRecorder self, DataType data_type) -> std::string
    ...
    def data_type_to_string(data_type):
        """
        data_type_to_string(DataType data_type) -> std::string
...
def PyDataRecorder_data_type_to_string(data_type):
    """
    PyDataRecorder_data_type_to_string(DataType data_type) -> std::string
