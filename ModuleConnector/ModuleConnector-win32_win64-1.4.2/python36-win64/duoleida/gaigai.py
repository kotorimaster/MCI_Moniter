...
for i in range(250):
    ...
    # c = c[1:len(c) - 1]
    # cc = c.split()
    # end_xaa, end_yaa, end_xbb, end_ybb=data_fu.fu(aa,bb,cc,chushi_xa,chushi_ya,chushi_xb,chushi_yb,re_la,re_la_str,chaa,chab,banjing)
    #
    #
    #
...
# file=open('C:/Users/yyb/Desktop/brs/radar_33.txt','w')
# for fp in result3:
# 	file.write(str(fp))
# 	file.write('\n')
# file.close()
# file=open('C:/Users/yyb/Desktop/brs/radar_22.txt','w')
# for fp in result2:
# 	file.write(str(fp))
# 	file.write('\n')
# file.close()
# file=open('C:/Users/yyb/Desktop/brs/radar_11.txt','w')
# for fp in result1:
# 	file.write(str(fp))
# 	file.write('\n')
# file.close()
