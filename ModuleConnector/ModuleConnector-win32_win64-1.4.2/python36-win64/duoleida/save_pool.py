...
def try_xep(start,i,com,fre):
    ...
    with create_mc(com) as mc:
        ...
        # Set TX center freq
        xep.x4driver_set_tx_center_frequency(fre);
        ...
        # Reset module
        sio.savemat('C:/Users/yyb/Desktop/ceshi/radar'+i+'_single.mat', {'radar'+i: save2})
        xep.module_reset()
...
if __name__=='__main__':
   ...
   # p.apply_async(try_xep, args=(aaa,"1","com5",3))
    p.apply_async(try_xep, args=(aaa, "2", "com8",4))
