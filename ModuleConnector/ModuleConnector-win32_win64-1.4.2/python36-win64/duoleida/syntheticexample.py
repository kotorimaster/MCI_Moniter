...
r1=load_r1['radar1']
load_r2=sio.loadmat('C:/Users/yyb/Desktop/2_man_demo/track/radar2_1.mat')
r2=load_r2['radar2']
...
# file=open('C:/Users/yyb/Desktop/brss/x_11.txt','r')
...
# file.close()
#
# file=open('C:/Users/yyb/Desktop/brss/y_11.txt','r')
# list_read=file.readlines()
# for line in list_read:
#     line=line.strip('\n')
#     data2.append(line)
...
for i in range(150):
	...
	def chuli(a3):
		...
		for jjjj in range(len(a3_list)):
			...
			plt.scatter(i, tt, color='r', s=area)
...
#
# file=open('C:/Users/yyb/Desktop/brss/p1_3.txt','w')
# for fp in results:
# 	file.write(str(fp))
# 	file.write('\n')
# file.close()
