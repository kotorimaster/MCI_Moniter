...
t1 = threading.Thread(name="1", target=x1,args=(con,1,"1","com16"))
t2 = threading.Thread(name="2", target=x2,args=(con,1,"2","com5"))
...
br_leji1=np.zeros((1,550))
br_leji2=np.zeros((1,550))
br_leji3=np.zeros((1,550))
x_p = 0
y_p = 0
...
while (True):
    ...
    if (tmp1 != [] and tmp2 != [] and tmp3 != [] and ycl == 100):
        ...
        hrs1, brs1 = mlab.respiration_multi2(PD1, nout=2)
        hrs2, brs2 = mlab.respiration_multi2(PD2, nout=2)
        hrs3, brs3 = mlab.respiration_multi2(PD3, nout=2)
        ...
        km3 = Kalman(i_v3, 0)
        print("<<<<<<<<<<<<<br and hr<<<<<<<<<<<<<<<")
        print((hrs1+hrs2+hrs3)/3)
        print((brs1+brs2+brs3)/3)
        print("<<<<<<<<<<<<<br and hr<<<<<<<<<<<<<<<")
        # print(leji1.shape)
        # print(leji2.shape)
        # print(leji3.shape)
    ...
    if(tmp1!=[] and tmp2!=[] and tmp3!=[] and ycl>100 ):
        ...
        if(ycl%10==0):
            hrs1, brs1 = mlab.respiration_multi2(PureData1, nout=2)
            hrs2, brs2 = mlab.respiration_multi2(PureData2, nout=2)
            hrs3, brs3 = mlab.respiration_multi2(PureData3, nout=2)


            print("<<<<<<<<<<<<<br and hr<<<<<<<<<<<<<<<")
            print(str(brs1)+"   "+str(brs2)+"   "+str(brs3)+"   ")
            print(str(hrs1) + "   " + str(hrs2) + "   " + str(hrs3) + "   ")
