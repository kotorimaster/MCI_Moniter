...
for i in range(100):
    ...
    jg2 = km2.x[0, 0]/156
    jg3= km3.x[0, 0]/156
    tmp1.append(float(jg))
    tmp2.append(float(jg2))
    tmp3.append(float(jg3))
    print tmp1
...
# plt.xticks(xl)
# plt.yticks(yl)
file=open('C:/Users/yyb/Desktop/brss/s_rr1.txt','w')
for fp in result1:
	file.write(str(fp))
	file.write('\n')
file.close()
file=open('C:/Users/yyb/Desktop/brss/s_rr2.txt','w')
for fp in result2:
	file.write(str(fp))
	file.write('\n')
file.close()
file=open('C:/Users/yyb/Desktop/brss/s_rr3.txt','w')
for fp in result3:
	file.write(str(fp))
	file.write('\n')
file.close()
