...
#path="/home/pi/workspace/timetest/"
#os.mkdir(path)
...
ser2=serial.Serial("/dev/device3",9600)
ser3=serial.Serial("/dev/device1",9600)
...
while (True):
    ...
    if(tmp1!=[] and tmp2!=[] and tmp3!=[] and ycl<100 ):
        ...
        #if ycl==99:
        #    innitend=time.time()
        #    innittime=innitend-innitbegin
        #    print("initialize time:%f",innittime)
        #print(ycl)
        tmp1=[]
        tmp2=[]
    ...
    if(tmp1!=[] and tmp2!=[] and tmp3!=[] and ycl>100 ):
        ...
        #with open(path+"processtime.txt","a+")as file:
        #    file.write(str(processend-processstart)+'\r\n')
        #file.close
        ...
        # plt.show()
        # plotend=time.time()
        # with open(path+"plottime.txt","a+") as f:
        #     f.write(str(plotend-plotbegin)+'\r\n')
        # f.close()
        # #print("plottime:%f",plotend-plotbegin)
        ...
        # with open(path+"totaltime.txt","a+") as f2:
        #     f2.write(str(plotend)+"\r\n")
        # f2.close()
        con.notifyAll()
        #end = time.time()
        #print("+++++++++++++++++++++++++++++++++")
