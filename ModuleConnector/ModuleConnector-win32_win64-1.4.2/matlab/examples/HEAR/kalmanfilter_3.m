function  x_fil=kalmanfilter_3(y,wavData)
N = length(y);  % Duration of movement
P=0.001;
Q=0.5;
a=1;
H=1;
...
p=zeros(N,2);
for t=2:N                %%% multiple innovations
...
t=1:N;
% figure;hold on;plot(t,z,'g');
% plot(t,x_fil,'r');
% plot(y);
% legend('Filtering','measurement');