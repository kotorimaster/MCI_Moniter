...
function [xueyangyihb,xueyangyitime] = oximeter2()
dos('2.bat');
%clc
fidin=fopen('C:\Users\mengyao\Desktop\2\value.txt');                               % 打开test2.txt文件
...
value=value';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%时间
fidin=fopen('C:\Users\mengyao\Desktop\2\time.txt');                               % 打开test2.txt文件
