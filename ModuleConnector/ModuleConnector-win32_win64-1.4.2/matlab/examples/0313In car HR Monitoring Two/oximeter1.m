...
function [xueyangyihb,xueyangyitime] = oximeter1()
dos('1.bat');
%clc
fidin=fopen('C:\Users\mengyao\Desktop\1\value.txt');                               % 打开test2.txt文件
...
value=value';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%时间
fidin=fopen('C:\Users\mengyao\Desktop\1\time.txt');                               % 打开test2.txt文件
