...
X1=xlsread('C:\Users\mac\Desktop\20180704\旧雷达特征\count_oldandnew4.xlsx');
...
Y1= [zeros(175, 1); ones(225, 1)*1; ones(225, 1)*2; ones(175, 1)*3];
...
% X_tst = X1(randvector1(901:end),:);
% Y_tst = Y1(randvector1(901:end),:);
