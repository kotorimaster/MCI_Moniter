function [pp]=che_xiuxiuxiu417(RawData7,xiu)
tic
FrameStitchnum=3;
SpeedOfLight=3*10^8;
Resolution=1/256;
...
e_frontmean = mean(e_front);
e_backmean = mean(e_back);
e1mean = mean(e1);
e2mean = mean(e2);
e3mean = mean(e3);
e4mean = mean(e4);
e5mean = mean(e5);
ampmaxmean = mean(ampmax);
ampmax1mean = mean(ampmax1);
ampmax2mean = mean(ampmax2);
ampmax3mean = mean(ampmax3);
ampmax4mean = mean(ampmax4);
ampmax5mean = mean(ampmax5);
ampmeanmean = mean(ampmean);
am_frontmean = mean(am_front);
am_backmean = mean(am_back);


input_my = [energymean e_frontmean e_backmean e1mean e2mean e3mean e4mean e5mean ampmaxmean ampmax1mean ampmax2mean ampmax3mean ampmax4mean ampmax5mean ampmeanmean am_frontmean am_backmean Ebin1meanmean Abin1meanmean Emax1meanmean Emax_denoise1meanmean Ebin2meanmean Abin2meanmean Emax2meanmean Emax_denoise2meanmean Ebin3meanmean Abin3meanmean Emax3meanmean Emax_denoise3meanmean]; 
