...
function [Y_new, votes, prediction_per_tree] = classRF_predict_xiu(X,xiu, extra_options)
	...
	[Y_hat,prediction_per_tree,votes] = mexClassRF_predict(X',xiu.model.nrnodes,xiu.model.ntree,xiu.model.xbestsplit,xiu.model.classwt,xiu.model.cutoff,xiu.model.treemap,xiu.model.nodestatus,xiu.model.nodeclass,xiu.model.bestvar,xiu.model.ndbigtree,xiu.model.nclass, predict_all);
	%keyboard
    votes = votes';
    ...
    Y_new = double(Y_hat);
    new_labels = xiu.model.new_labels;
    orig_labels = xiu.model.orig_labels;
