        ...
        for r2_1 in range(tmp_dist2.size):
            ...
            if(len1+len2>=l):
                ...
                if(x.imag==0 and y11.imag==0 and y21.imag==0):
                    ...
                    if(abs(y11-y21)<dj):
                        if(x<=0.5*l and x>=-0.5*l and (y11-0.578*x)>=0 and (y11+0.578*x)>=0 and(y11-0.578*x)<=1.155*l and (y11+0.578*x)<=1.155*l ):
                            spot=np.vstack((spot,x_y11))
                        if (x <= 0.5 * l and x >= -0.5 * l and (y21 - 0.578 * x) >= 0 and (y21 + 0.578 * x) >= 0 and (
                                    y21 - 0.578 * x) <= 1.155 * l and (y21 + 0.578 * x) <= 1.155 * l):
    ...
    for r1_2 in range(tmp_dist.size):
        ...
        for r3_2 in range(tmp_dist3.size):
            ...
            if(len1+len3>=l):
                ...
                # print(l1)
                # print(l2)
                y12=0.433*(len3*len3-len1*len1+l*l)/l+cmath.sqrt(4*len3*len3-((len3*len3-len1*len1+l*l)/l)*((len3*len3-len1*len1+l*l)/l))/4
                y22 = 0.433*(len3*len3-len1*len1+l*l)/l-cmath.sqrt(4*len3*len3-((len3*len3-len1*len1+l*l)/l)*((len3*len3-len1*len1+l*l)/l))/4
                ...
                if (x22.imag==0 and x12.imag == 0 and y12.imag == 0 and y22.imag == 0):
                    ...
                    if (abs(y12 - y22) < dj and abs(x12-x22)<dj):
                        if (x12 <= 0.5 * l and x12 >= -0.5 * l and (y12 - 0.578 * x12) >= 0 and (y12 + 0.578 * x12) >= 0 and (
                                y12 - 0.578 * x12) <= 1.155 * l and (y12 + 0.578 * x12) <= 1.155 * l):
                            spot=np.vstack((spot,x_y12))
                        if (x22 <= 0.5 * l and x22 >= -0.5 * l and (y22 - 0.578 * x22) >= 0 and (y22 + 0.578 * x22) >= 0 and (
                                y22 - 0.578 * x22) <= 1.155 * l and (y22 + 0.578 * x22) <= 1.155 * l):
    ...
    for r2_3 in range(tmp_dist2.size):
        ...
        for r3_3 in range(tmp_dist3.size):
            ...
            if(len2+len3>=l):
                ...
                # print(l1)
                # print(l2)
                y13 = 0.433 * (len3 * len3 - len2 * len2 + l * l) / l + cmath.sqrt(
                    4 * len3 * len3 - ((len3 * len3 - len2 * len2 + l * l) / l) * (
                            (len3 * len3 - len2 * len2 + l * l) / l)) / 4
                y23 = 0.433 * (len3 * len3 - len2 * len2 + l * l) / l - cmath.sqrt(
                    4 * len3 * len3 - ((len3 * len3 - len2 * len2 + l * l) / l) * (
                            (len3 * len3 - len2 * len2 + l * l) / l)) / 4
                x13 = -cmath.sqrt(len3 * len3 - y13 * y13)
                x23 = -cmath.sqrt(len3 * len3 - y23 * y23)
                y13 = complex(y13)
                ...
                if (x23.imag == 0 and x13.imag == 0 and y13.imag == 0 and y23.imag == 0):
                    ...
                    if (abs(y13- y23) < dj and abs(x13 - x23) <dj):
                        if (x13 <= 0.5 * l and x13 >= -0.5 * l and (y13 - 0.578 * x13) >= 0 and (
                                y13 + 0.578 * x13) >= 0 and (
                                y13 - 0.578 * x13) <= 1.155 * l and (y13 + 0.578 * x13) <= 1.155 * l):
                            spot = np.vstack((spot, x_y13))
                        if (x23 <= 0.5 * l and x23 >= -0.5 * l and (y23 - 0.578 * x23) >= 0 and (
                                y23 + 0.578 * x23) >= 0 and (
                                y23 - 0.578 * x23) <= 1.155 * l and (y23 + 0.578 * x23) <= 1.155 * l):
