...
data2=[]
data3=[]
file=open('C:/Users/yyb/Desktop/brss/x33333.txt','r')
...
file=open('C:/Users/yyb/Desktop/brss/x11111.txt','r')
list_read=file.readlines()
for line in list_read:
    line=line.strip('\n')
    data1.append(line)
...
file=open('C:/Users/yyb/Desktop/brss/x22222.txt','r')
list_read=file.readlines()
for line in list_read:
    line=line.strip('\n')
    data2.append(line)
...
def solv_13(r1,r3):
    ...
    y1_1=cmath.sqrt(3)/4*yuan+cmath.sqrt((r3*r3-yuan*yuan)/4+(cmath.sqrt(3)/4*yuan)*(cmath.sqrt(3)/4*yuan))
...
def solv_23(r2,r3):
    ...
    y1_2 = -cmath.sqrt(3) / 4 * yuan + cmath.sqrt((r3 * r3 - yuan * yuan) / 4 + (cmath.sqrt(3) / 4 * yuan) * (cmath.sqrt(3) / 4 * yuan))
...
for i in range(120):
        ...
        for j2 in range(len(bb)):
            ...
            for j3 in range(len(cc)):
                ...
                if tmp1+tmp2>=banjing:
                    ...
                    if x1>-2 and x1<2 and y1<2 * cmath.sqrt(3).real and y1>0 and xx1==0 and((x1<0 or x1>0.2) or(y1<2.2 or y1>2.6)):
                    ...
                    print 2222
                    if x2 > -2 and x2 < 2 and y2 < 2 * cmath.sqrt(3).real and y2 > 0 and xx2==0 and((x2<0 or x2>0.2) or(y2<2.2 or y2>2.6))and((x2<0 or x2>0.2) or(y2<1.6 or y2>2)):
                ...
                if tmp3 + tmp2 >= banjing:
                    ...
                    if x1 > -2 and x1 < 2 and y1 < 2 * cmath.sqrt(3).real and y1 > 0  and xx11 == 0 and((x1<0 or x1>0.2) or(y1<2.2 or y1>2.6))and((x1<0 or x1>0.2) or(y1<1.6 or y1>2)):
                    ...
                    if x2 > -2 and x2 < 2 and y2 < 2 * cmath.sqrt(3).real and y2 > 0 and xx22 ==0 and((x2<0 or x2>0.2) or(y2<2.2 or y2>2.6))and((x2<0 or x2>0.2) or(y2<1.6 or y2>2)):
                ...
                if tmp1 + tmp3 >= banjing:
                    ...
                    if x1 > -2 and x1 < 2 and y1 < 2 * cmath.sqrt(3).real and y1 > 0 and yy11 == 0 and((x1<0 or x1>0.2) or(y1<2.2 or y1>2.6)) and((x1<0 or x1>0.2) or(y1<1.6 or y1>2)):
                    # if y1 < 2 * cmath.sqrt(3).real and y1 > cmath.sqrt(3).real * x1 and y1 > -cmath.sqrt(
                    #         3).real * x1 and yy1 == 0:
                    #     ttmmppx.append(x1)
                    #     ttmmppy.append(y1)
                    ...
                    if x1 > -2 and x1 < 2 and y2 < 2 * cmath.sqrt(3).real and y2 > 0 and yy22 == 0 and((x1<0 or x1>0.2) or(y2<1.6 or y2>2))and((x1<0 or x1>0.2) or(y1<2.2 or y1>2.6)):
    ...
    print end_xbb
    print end_ybb
    ttmmppxx.append(end_xaa)
    ttmmppyx.append(end_yaa)
    plt.scatter(end_xaa, end_yaa, color='b', s=area)
    plt.xticks(xl)
    plt.yticks(yl)
    ttmmppxs.append(end_xbb)
    ttmmppys.append(end_ybb)
    ...
    resultxx.append(ttmmppxx)
    resultyx.append(ttmmppyx)
    resultxs.append(ttmmppxs)
    resultys.append(ttmmppys)
file=open('C:/Users/yyb/Desktop/brre/knn2_xxie.txt','w')
for fp in resultxx:
	file.write(str(fp))
	file.write('\n')
file.close()

file=open('C:/Users/yyb/Desktop/brre/knn2_yxie.txt','w')
for fp in resultyx:
	file.write(str(fp))
	file.write('\n')
file.close()

file=open('C:/Users/yyb/Desktop/brre/knn2_xshu.txt','w')
for fp in resultxs:
	file.write(str(fp))
	file.write('\n')
file.close()

file=open('C:/Users/yyb/Desktop/brre/knn2_yshu.txt','w')
for fp in resultys:
	file.write(str(fp))
	file.write('\n')
file.close()
