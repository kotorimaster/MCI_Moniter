...
data2=[]
data3=[]
file=open('C:/Users/yyb/Desktop/brs/x3.txt','r')
...
file=open('C:/Users/yyb/Desktop/brs/x1.txt','r')
list_read=file.readlines()
for line in list_read:
    line=line.strip('\n')
    data1.append(line)
...
file=open('C:/Users/yyb/Desktop/brs/x2.txt','r')
list_read=file.readlines()
for line in list_read:
    line=line.strip('\n')
    data2.append(line)
...
for i in range(80):
    ...
    print end_xbb
    print end_ybb
    ttmmppxl.append(end_xaa)
    ttmmppyl.append(end_yaa)
    plt.scatter(end_xaa, end_yaa, color='b', s=area)
    plt.xticks(xl)
    plt.yticks(yl)
    ttmmppxr.append(end_xbb)
    ttmmppyr.append(end_ybb)
    ...
    resultxr.append(ttmmppxr)
    resultyr.append(ttmmppyr)
    resultxl.append(ttmmppxl)
    resultyl.append(ttmmppyl)

file=open('C:/Users/yyb/Desktop/brre/knn1_xl.txt','w')
for fp in resultxl:
	file.write(str(fp))
	file.write('\n')
file.close()

file=open('C:/Users/yyb/Desktop/brre/knn1_yl.txt','w')
for fp in resultyl:
	file.write(str(fp))
	file.write('\n')
file.close()

file=open('C:/Users/yyb/Desktop/brre/knn1_xr.txt','w')
for fp in resultxr:
	file.write(str(fp))
	file.write('\n')
file.close()

file=open('C:/Users/yyb/Desktop/brre/knn1_yr.txt','w')
for fp in resultyr:
	file.write(str(fp))
	file.write('\n')
file.close()
