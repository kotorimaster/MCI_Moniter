...
def x1(con,start,i,com):
    ...
    with create_mc(com) as mc:
        ...
        # Set frame area
        xep.x4driver_set_frame_area(0.2, 7)
        ...
        # Stop streaming
        xep.x4driver_set_fps(15)
        print(i + " wait")
        save1 = np.ones((500, 1064))
        ...
        sio.savemat('C:/Users/yyb/Desktop/single_man/r111.mat', {'radar1': save1})
...
def x2(con,start,i,com):
    ...
    with create_mc(com) as mc:
        ...
        print('save2!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
        print('save2!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
        sio.savemat('C:/Users/yyb/Desktop/wcsp/r2222.mat', {'radar2': save2})
...
def x3(con,start,i,com):
    ...
    with create_mc(com) as mc:
        ...
        sio.savemat('C:/Users/yyb/Desktop/wcsp/r3333.mat', {'radar3': save3})
...
# t2 = threading.Thread(name="2", target=x2,args=(con,aaa,"2","com6"))
# t3 = threading.Thread(name="3", target=x3,args=(con,aaa,"3","com7"))
time.sleep(2)
t1.start()
# t2.start()
# # #
