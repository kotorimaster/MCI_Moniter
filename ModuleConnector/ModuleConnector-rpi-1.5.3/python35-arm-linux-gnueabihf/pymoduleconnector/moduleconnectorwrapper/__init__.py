...
class PyXEP(_object):
    ...
    def x4driver_set_dac_step(self, dac_step: 'uint8_t') -> "void":
        """
    ...
    def x4driver_get_dac_step(self) -> "uint8_t":
        """
        x4driver_get_dac_step(PyXEP self) -> uint8_t
        ...
        """
        return _moduleconnectorwrapper.PyXEP_x4driver_get_dac_step(self)
...
def throw_python_exception(msg: 'char const *') -> "void":
    """throw_python_exception(char const * msg)"""
    return _moduleconnectorwrapper.throw_python_exception(msg)
